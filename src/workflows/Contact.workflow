...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <fieldUpdates>
        <fullName>Autofill_First_Income</fullName>
        <field>First_Income__c</field>
        <formula>Most_Recent_Income__c</formula>
        <name>Autofill First Income</name>
        <notifyAssignee>false</notifyAssignee>
        <operation>Formula</operation>
        <protected>false</protected>
    </fieldUpdates>
    <fieldUpdates>
        <fullName>Deceased_Checkbox_Update</fullName>
        <field>C4G_Deceased__c</field>
        <literalValue>1</literalValue>
        <name>Deceased Checkbox Update</name>
        <notifyAssignee>false</notifyAssignee>
...
OtherPhone 
    ...
    <rules>
        <fullName>Autofill First Income</fullName>
        <actions>
            <name>Autofill_First_Income</name>
            <type>FieldUpdate</type>
        </actions>
        <active>false</active>
        <criteriaItems>
            <field>Contact.Most_Recent_Income__c</field>
            <operation>equals</operation>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Check Deceased Checkbox</fullName>
        <actions>
            <name>Deceased_Checkbox_Update</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Contact.C4G_Deceased_Date__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <description>When the Deceased Date field is filled out, the &quot;Deceased&quot; Checkbox is also checked.</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
        <fullName>Followup Assistance</fullName>
        <actions>
            <name>A_client_has_requested_followup_assistance</name>
            <type>Task</type>
        </actions>
        <active>true</active>
        <criteriaItems>
            <field>Contact.Requested_Followup_Assistance__c</field>
            <operation>notEqual</operation>
        </criteriaItems>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    ...
    <rules>
        <fullName>Update Partner Address</fullName>
        <active>false</active>
        <criteriaItems>
        ...
        <description>Updates partner address to match account address</description>
        <triggerType>onCreateOrTriggeringUpdate</triggerType>
    </rules>
    <rules>
    ...
    <tasks>
        <fullName>A_client_has_requested_followup_assistance</fullName>
        <assignedTo>jaison.mccall@stlouiscommunity.com</assignedTo>
        <assignedToType>user</assignedToType>
        <description>Please refer to the contact&apos;s record for more details.</description>
        <dueDateOffset>7</dueDateOffset>
        <notifyAssignee>false</notifyAssignee>
        <priority>Normal</priority>
        <protected>false</protected>
        <status>Not Started</status>
        <subject>A client has requested followup assistance</subject>
    </tasks>
    <tasks>
